...
const CategoryItem: React.FC<CategoryItemProps> = ({ title, linkTo, isActive }) => {
  return (
    <Link
      to={linkTo}
      className={cn(
        'text-base 2xl:text-xl font-medium rounded-xl flex justify-center items-center hover:bg-neutral-200 hover:text-neutral-900 hover:border hover:border-black w-full h-18 px-5 py-2.5',
