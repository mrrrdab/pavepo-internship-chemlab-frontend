...
const CheckoutForm: React.FC = () => {
  ...
  return (
    <form autoComplete="off" onSubmit={handleSubmit(onSubmit)} className="relative">
      <div className="grid auto-rows-auto grid-cols-[1fr_1fr_33%] gap-x-5 gap-y-16">
        ...
        <div className="col-start-3 row-span-2 flex flex-col gap-6">
          <div>
            ...
            <OrderSuccessModal
              trigger={
                <Button type="submit" variant="outline" disabled={!isValid} className="font-medium rounded w-full h-12">
                  Оформить заказ
                </Button>
              }
              onClose={deleteProducts}
            ></OrderSuccessModal>
          </div>
